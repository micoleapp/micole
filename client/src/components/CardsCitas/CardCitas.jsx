              ...
              <>
                <div className={style.container}>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "10px" , flexDirection:'row',alignItems:'center',   fontSize:'1.8vh'}}>
                    <img
                  ...
                  <div style={{ display: "flex", gap: "5px", width:'100%', justifyContent:'center', flexDirection:'column' }}>
                  <div  className={style.itemDiv} >
                        <PhoneIcon 
                          style={{
                            width: "20px",
